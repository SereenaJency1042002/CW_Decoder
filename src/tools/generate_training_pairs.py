...
LABEL_FILES = [
    "data/audio_files/training data set/labels.csv",
    "data/augmented_data/train/labels.csv",
    "data/augmented_data/val/labels.csv",
]

OUTPUT_FILE = "data/morse_training_pairs.csv"
